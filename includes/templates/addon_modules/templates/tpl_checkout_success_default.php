...
<?php echo zen_draw_checkbox_field('notify[]', $notifications['products_id'], false, 'id="notify-' . $notifications['counter'] . '" disabled="disabled"') ;?>
<label class="checkboxLabel" for="<?php echo 'notify-' . $notifications['counter']; ?>"><?php echo $notifications['products_name']; ?></label>
<br />
<?php } ?>
<div id="checkoutSuccessInfoNotifyProducrs" class="alert"><?php echo TEXT_INFO_VISITORS_NOTIFY_PRODUCTS; ?></div>
</fieldset>
<?php
    }
?>
...
<div id="checkoutSuccessOrderLink"><?php echo TEXT_VISITORS_SEE_ORDERS;?></div>

<div id="checkoutSuccessInfoOrderLink" class="alert"><?php echo TEXT_INFO_VISITORS_SEE_ORDERS; ?></div>

<fieldset id="visitorsToAccount">
<legend><?php echo TEXT_VISITOR_TO_ACCOUNT; ?></legend>

<div class="information"><?php echo TEXT_VISITOR_TO_ACCOUNT_INTRODUCTION; ?></div>

<div class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_ADDON, 'module=visitors/visitor_to_account', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_NEXT, BUTTON_NEXT_ALT) . '</a>'; ?></div>
