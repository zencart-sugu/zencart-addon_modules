 ...
 * @version $Id: tpl_checkout_confirmation_default.php $
 */
?>
...
?>
<div id="checkoutCustomer" class="back">
<h2 id="checkoutConfirmDefaultCustomerAddress"><?php echo HEADING_CUSTOMER_ADDRESS; ?></h2>
<div class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_ADDON, 'module=visitors/visitor_edit', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
