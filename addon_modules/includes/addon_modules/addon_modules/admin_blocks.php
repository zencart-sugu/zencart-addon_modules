  ...
  if ($dir = @dir($pages_directory)) {
    while ($file = $dir->read()) {
      if (is_dir($pages_directory . $file) && !preg_match('/^\..*|^popup.*|^redirect$|^download$|^checkout_process$|^addon$/', $file)) {
        $directory_array[] = $file;
	if ($file == FILENAME_DEFAULT) {
	  $directory_array[] = $file . '_categories';
	  $directory_array[] = $file . '_products';
	}
      }
    }
    if (sizeof($directory_array)) {
  ...
  if ($_GET['action']) {
    switch ($_GET['action']) {
      case 'save':
        ...
        zen_redirect(zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $id));
      ...
      case 'deleteconfirm':
        ...
        zen_redirect(zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page']));
      ...
      case 'save_all':
        ...
        zen_redirect(zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $_GET['bID']));
...
?>
            <td valign="top">
              <?php echo zen_draw_form('block_layouts', FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $_GET['bID'] . '&action=save_all'); ?>
...
?>
                ...
                <td class="dataTableContent" align="right">
                  ...
                  <?php echo '<a href="' . zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $block_layouts->fields['id'] . '&action=edit') . '">' . zen_image(DIR_WS_IMAGES . 'icon_edit.gif', IMAGE_EDIT) . '</a>'; ?>
                  <?php if ( (is_object($bInfo)) && ($block_layouts->fields['id'] == $bInfo->id) ) { echo zen_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', ''); } else { echo '<a href="' . zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $block_layouts->fields['id']) . '">' . zen_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
<?php
   } else {
...
?>
              ...
              <tr valign="top">
                <td colspan="6" align="center">
                  ...
                  <a href="<?php echo zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $_GET['bID']); ?>"><?php echo zen_image_button('button_cancel.gif', IMAGE_CANCEL); ?></a>
                </td>
              </tr>
            </table>
            </form>
    ...
    switch ($_GET['action']) {
      case 'edit':
        ...
        if ($bInfo->module == 'sideboxes') {
          ...
          $contents = array('form' => zen_draw_form('block_layouts', FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $bInfo->id . '&action=save' . '&block=' . $bInfo->block));
        ...
        $contents[] = array('align' => 'center', 'text' => '<br />' . zen_image_submit('button_update.gif', IMAGE_UPDATE) . '&nbsp;<a href="' . zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $bInfo->id . '&block=' . $bInfo->block) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
        break;
      ...
      case 'delete':
        if ($bInfo->module == 'sideboxes') {
          ...
          $contents = array('form' => zen_draw_form('block_layouts', FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $bInfo->id . '&action=deleteconfirm' . '&block=' . $bInfo->block));
        ...
        $contents[] = array('align' => 'center', 'text' => '<br />' . zen_image_submit('button_delete.gif', IMAGE_DELETE) . '&nbsp;<a href="' . zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $bInfo->id) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
        break;
      ...
      default:
        ...
        if ($bInfo->module == 'sideboxes') {
          ...
          $contents[] = array('align' => 'left', 'text' => '<a href="' . zen_href_link(FILENAME_ADDON_MODULES_ADMIN, 'module=addon_modules/blocks&page=' . $_GET['page'] . '&bID=' . $bInfo->id . '&action=edit') . '">' . zen_image_button('button_edit.gif', IMAGE_EDIT) . '</a>');
