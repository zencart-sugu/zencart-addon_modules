 ...
 * @version $Id: admin_generate_module.php 184 2011-11-22 01:33:14Z s.kohata $
 */
...
define('MODULE_MODULE_GENERATE_ADD', '追加');
define('MODULE_MODULE_GENERATE_REMOVE', '削除');
...
define('MODULE_MODULE_GENERATE_ERROR_MODULE_ALREADY_EXISTS', 'モジュール %s は既に存在します。');
define('MODULE_MODULE_GENERATE_ERROR_MODULE_DIRECTORY_CANNOT_CREATE', 'モジュールディレクトリ %s を作成できませんでした。%sのパーミッションを確認してください。');
define('MODULE_MODULE_GENERATE_SUCCESS', 'モジュール %s が作成されました。');
?>