 ...
 * @version $Id: tpl_login_default.php $
 */
?>
...
<?php
if (VISITORS_PURCHASE_ENABLED === true) {
?>
<fieldset><legend><?php echo HEADING_NEW_CUSTOMER_WITH_VISITORS; ?></legend>

<div class="information"><?php echo TEXT_NEW_CUSTOMER_INTRODUCTION_WITH_VISITORS; ?></div>

<div class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_NEXT, BUTTON_NEXT_ALT) . '</a>'; ?></div>
...
<fieldset><legend><?php echo HEADING_NEW_VISITORS; ?></legend>

<div class="information"><?php echo TEXT_NEW_VISITORS_INTRODUCTION; ?></div>

<?php require($GLOBALS['visitors']->getModuleTemplate($current_page_base, 'module_create_visitor')); ?>
